...
- **TTL / expiry** — share links expire after **1–30 days** (chosen at share time, default 7). Expired objects are deleted on access and reaped by lifecycle rules. No indefinite storage.
